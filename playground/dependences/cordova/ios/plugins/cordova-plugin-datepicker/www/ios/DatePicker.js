cordova.define('cordova-plugin-datepicker.DatePicker', function(
  require,
  exports,
  module,
) {
...
*/
  ...
  DatePicker.prototype.show = function(options, cb) {
    ...
    var defaults = {
      ...
      y: '0',
      minuteInterval: 1,
      popoverArrowDirection: this._popoverArrowDirectionIntegerFromString(
        'any',
      ),
      locale: 'en_US',
    };
  ...
  DatePicker.prototype._popoverArrowDirectionIntegerFromString = function(
    string,
  ) {
